...
export const AVAILABLE_PERMISSIONS: Permission[] = [
    ...
    // --- Módulo Financeiro ---
    { code: 'financeiro.dashboard.contabilidade', label: 'Dashboard', category: 'NZD Contabilidade', module: 'Módulo Financeiro' },
    { code: 'financeiro.cobranca.contabilidade.view', label: 'Acessar Cobrança', category: 'NZD Contabilidade', module: 'Módulo Financeiro' },
    { code: 'financeiro.cobranca.contabilidade.detalhar', label: 'Detalhar Título', category: 'NZD Contabilidade', module: 'Módulo Financeiro' },
    { code: 'financeiro.cobranca.contabilidade.receber', label: 'Registrar Recebimento', category: 'NZD Contabilidade', module: 'Módulo Financeiro' },
    { code: 'financeiro.cobranca.contabilidade.receber.cancelar', label: 'Cancelar Recebimento', category: 'NZD Contabilidade', module: 'Módulo Financeiro' },
    { code: 'financeiro.cobranca.contabilidade.boleto', label: 'Visualizar Boleto', category: 'NZD Contabilidade', module: 'Módulo Financeiro' },
    { code: 'financeiro.cobranca.contabilidade.digisac', label: 'Enviar Boleto via Digisac', category: 'NZD Contabilidade', module: 'Módulo Financeiro' },

    { code: 'financeiro.dashboard.consultoria', label: 'Dashboard', category: 'NZD Consultoria', module: 'Módulo Financeiro' },
    { code: 'financeiro.cobranca.consultoria.view', label: 'Acessar Cobrança', category: 'NZD Consultoria', module: 'Módulo Financeiro' },
    { code: 'financeiro.cobranca.consultoria.detalhar', label: 'Detalhar Título', category: 'NZD Consultoria', module: 'Módulo Financeiro' },
    { code: 'financeiro.cobranca.consultoria.receber', label: 'Registrar Recebimento', category: 'NZD Consultoria', module: 'Módulo Financeiro' },
    { code: 'financeiro.cobranca.consultoria.receber.cancelar', label: 'Cancelar Recebimento', category: 'NZD Consultoria', module: 'Módulo Financeiro' },
