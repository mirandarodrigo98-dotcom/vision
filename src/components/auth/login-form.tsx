...
export function LoginForm({ logoUrl }: LoginFormProps) {
  ...
  // Fallback handler if needed, though handleLogin handles password logic too now
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-start pt-10 sm:pt-16 bg-gray-50 p-4">
      <div className={`${logoUrl ? 'mb-6' : '-mb-16'} text-center flex flex-col items-center z-10 relative`}>
        <img 
      ...
      <Card className="w-full max-w-md z-20 relative">
        <CardHeader>
          <CardTitle>
              ...
              {step === 'password' && 'Acesse sua conta'}
          </CardTitle>
          <CardDescription>
