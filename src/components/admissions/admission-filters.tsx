...
export function AdmissionFilters() {
  ...
  const [filters, setFilters] = useState({
    ...
    admission_date: searchParams.get('admission_date') || '',
  ...
  const handleFilter = () => {
    ...
    if (filters.admission_date) params.set('admission_date', filters.admission_date);
    ...
    <div className="space-y-4 bg-white p-4 rounded-md border mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-2 flex flex-col">
            ...
            <DatePicker
                date={parseDate(filters.admission_date)}
                setDate={(date) => handleFilterChange('admission_date', date ? format(date, 'yyyy-MM-dd') : '')}
