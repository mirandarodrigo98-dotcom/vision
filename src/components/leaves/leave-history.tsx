...
import { getLeaveHistory } from '@/app/actions/audit';
...
const ACTION_LABELS: Record<string, string> = {
    'CREATE_LEAVE': 'Solicitação de Afastamento',
    'UPDATE_LEAVE': 'Retificação de Afastamento',
    'CANCEL_LEAVE': 'Cancelamento de Afastamento',
    'APPROVE_LEAVE': 'Conclusão de Afastamento',
    'CANCEL_LEAVE_BY_ADMIN': 'Cancelamento por Admin'
};

export function LeaveHistory({ leaveId }: { leaveId: string }) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-md max-h-[80vh] flex flex-col">
                <DialogHeader>
                    <DialogTitle>Histórico de Afastamento</DialogTitle>
                    <DialogDescription>
