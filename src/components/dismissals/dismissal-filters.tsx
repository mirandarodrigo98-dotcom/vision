...
export function DismissalFilters() {
  ...
  const [filters, setFilters] = useState({
    ...
    dismissal_date: searchParams.get('dismissal_date') || '',
  ...
  const handleFilter = () => {
    ...
    if (filters.dismissal_date) params.set('dismissal_date', filters.dismissal_date);
