...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    >
      <Check className="h-3.5 w-3.5 text-primary hidden group-data-[state=checked]:block" strokeWidth={3} />
      <Minus className="h-3.5 w-3.5 text-muted-foreground hidden group-data-[state=unchecked]:block" strokeWidth={3} />
    </SwitchPrimitives.Thumb>
  </SwitchPrimitives.Root>
));
