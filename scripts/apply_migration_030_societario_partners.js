...
async function run() {
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, '../src/db/migrations/030_create_societario_partners.sql');
    ...
    console.log('Applying migration 030 (Societário: sócios, vínculos e histórico)...');
